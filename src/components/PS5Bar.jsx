    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
        ...
        <div style={{ fontSize: '0.8rem', fontWeight: 700, textAlign: 'right' }}>
          <span style={{ color: '#a78bfa' }}>{fmtDollar(paidSavings)} paid</span>
          {unpaidSavings > 0 && (
            <span style={{ color: 'rgba(255,255,255,0.45)', fontWeight: 400 }}>
              {' + '}
              <span style={{ color: '#fbbf24' }}>{fmtDollar(unpaidSavings)} unpaid</span>
            </span>
          )}
